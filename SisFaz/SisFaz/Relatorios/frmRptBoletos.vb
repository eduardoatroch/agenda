...
Public Class frmRptBoletos
    ...
    Private Sub ImprimirViaStreamer()
        ...
        For I = 0 To Me.lstvTitulosReceber.SelectedItems.Count - 1
            ...
            'Vencimento
            LinhaArquivoTexto = Space(83) & Me.lstvTitulosReceber.SelectedItems(I).SubItems(2).Text.Trim
            ...
            'Valor
            LinhaArquivoTexto = Space(85) & Me.lstvTitulosReceber.SelectedItems(I).SubItems(3).Text.Trim
            PrintLine(Arquivo, LinhaArquivoTexto)
            ContadorLinhas += 1
