...
Public Class frmRptTitulosAbertoPorFornecedor
    ...
    Private Sub frmRptTitulosAbertoPorFornecedor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ObterCaminhoRpt()
    ...
    Private Sub frmRptTitulosAbertoPorFornecedor_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.crvTitAbertoPorFornec.Height = Me.Height - 100
        Me.crvTitAbertoPorFornec.Width = Me.Width - 30
    End Sub
        ...
        Try
            ...
            If Me.cboFornecedor.Text.Trim <> "" Then
                ...
                sSQL = "select * from vwRptTitulosAbertoPorVencimento" & _
                       ...
                       " and Venc between '" & clsRotinas.DataParaSQLServer(Me.dtpDataInicio.Value) & "' and '" & clsRotinas.DataParaSQLServer(Me.dtpDataFinal.Value) & "'" & _
                       " and Pago=0" & _
                       " order by CodFornec"

            Else
                sSQL = "select * from vwRptTitulosAbertoPorVencimento" & _
                       " where Venc between '" & clsRotinas.DataParaSQLServer(Me.dtpDataInicio.Value) & "' and '" & clsRotinas.DataParaSQLServer(Me.dtpDataFinal.Value) & "'" & _
                       " and Pago=0" & _
                       " order by CodFornec"
            End If
            ...
            Me.crDocumento.Load(Me.CaminhoImp & "\rptTitulosAbertoPorFornecedor.rpt")
            ...
            Me.crvTitAbertoPorFornec.ParameterFieldInfo = pfs
            Me.crDocumento.SetDataSource(DS)
            Me.crvTitAbertoPorFornec.ReportSource = Me.crDocumento
