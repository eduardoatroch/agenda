...
Public Class frmRptTitulosPagoPorDataPagamento
    ...
    Private Sub frmRptTitulosPagoPorDataPagamento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmRptTitulosPagoPorDataPagamento_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Me.crvTituloPagoPorDataPagto.Height = Me.Height - 100
        Me.crvTituloPagoPorDataPagto.Width = Me.Width - 30
    End Sub
        ...
        Try
            ...
            If Me.cboFazenda.Text.Trim <> "" Then
                sSQL = "select * from vwRptTitulosAbertoPorVencimento" & _
                       ...
                       " and Pago=1" & _
                       " order by CodigoFazenda, DtPagto"
            ...
            Me.crDocumento.Load(Me.CaminhoImp & "\rptTitulosPagosPorDataPagto.rpt")
            'Me.crDocumento.Load(Application.StartupPath & "C:\SisFaz\SisFaz\Rpt\rptTitulosPagosPorDataPagto.rpt")
            ...
            Me.crvTituloPagoPorDataPagto.ParameterFieldInfo = pfs
            Me.crDocumento.SetDataSource(DS)
            Me.crvTituloPagoPorDataPagto.ReportSource = Me.crDocumento
