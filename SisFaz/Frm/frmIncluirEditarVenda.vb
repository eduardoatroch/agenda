    ...
    Private Sub SalvarVenda()
        ...
        Try
            ...
            With cmd
                ...
                .CommandType = CommandType.StoredProcedure
                .Parameters.Add("@CodigoCliente", SqlDbType.Int, 4)
                .Parameters(0).Value = CLng(Me.cboCliente.Text.Substring(Tam - 6, 6))
                .Parameters.Add("@DataVenda", SqlDbType.DateTime, 8)
                .Parameters(1).Value = Me.dtpDataVenda.Value.Date
                .Parameters.Add("@QtdeParc", SqlDbType.TinyInt, 1)
                .Parameters(2).Value = CByte(Me.txtParcelas.Text)
                .Parameters.Add("@Intervalo", SqlDbType.TinyInt, 1)
                .Parameters(3).Value = CByte(Me.txtIntervalo.Text)
                .Parameters.Add("@VencInicial", SqlDbType.DateTime, 8)
                .Parameters(4).Value = Me.dtpVencParcela.Value.Date
                .Parameters.Add("@ValorParc", SqlDbType.Decimal, 9)
                .Parameters(5).Value = CDec(Me.txtValorParcela.Text)
                .Parameters.Add("@JurosMes", SqlDbType.Decimal, 9)
                .Parameters(6).Value = CDec(Me.txtTaxaJurosMes.Text)
                .Parameters.Add("@Animal", SqlDbType.VarChar, 50)
                .Parameters(7).Value = Me.txtAnimal.Text.Trim
                .Parameters.Add("@ValorVenda", SqlDbType.Decimal, 9)
                ...
                .Parameters.Add("@Historico", SqlDbType.VarChar, 50)
                .Parameters(10).Value = Me.txtHistorico.Text.Trim

                If Not Incluir Then
                    .Parameters.Add("@CodigoVenda", SqlDbType.Int, 4)
        ...
        Try
            With cmd
                ...
                Do Until dtr.Read = False
                    ...
                    Me.txtHistorico.Text = dtr(10).ToString
                Loop
                dtr.Close()
                dtr = Nothing
                cnn.Close()
