Public Class Extenso
    ...
    Public Shared Function RetornarValorExtenso(ByVal Valor As String, ByVal GerarMoeda As Boolean) As String

        Dim strResult, strDecimal, strInteiro As String
        Dim VetorValorInteiro() As Char
        Dim Matrix() As String
        Dim CasasDecimais As String
        Dim i, ctd, Grupo, indMat, Tam As Integer
            ...
            Select Case i
                Case 0
                    ...
                    If CInt(Matrix(i)) <> 0 Then
                        ...
                        Dim DEC As String = classRotinas.CasasDecimais(CDec(CInt(Matrix(i)) / 100), 2)
